...
grep -Fq 'restart_source=${RESTART_SOURCE:-}' "$script"
grep -Fq 'remove_input_key rpa_pca_fixed_nu' "$script"
grep -Fq 'auxiliary_basis_rule=product_pca_threshold_only' "$script"
grep -Fq 'set_input_key init_wfc file' "$script"
grep -Fq 'set_input_key init_chg file' "$script"
