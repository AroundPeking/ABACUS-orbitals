...
grep -Fq 'OPTIMIZED_G_SOURCE' "$job"
grep -Fq 'OPTIMIZED_G_PROVENANCE' "$job"
grep -Fq 'OPTIMIZED_G_MAX_PRIMITIVES' "$job"
grep -Fq -- '--second-primitive-amplitude' "$job"
grep -Fq -- '--optimized-g-source' "$job"
grep -Fq -- '--optimized-g-max-primitives' "$job"
